...
class DU_IN(nn.Module):
    ...
    def __init__(self,in_ch=3,out_ch=1):
        ...
        self.stage1 = RSU7(in_ch,56,64)
        #  self.inv_1 = INVOL(64)
        self.pool12 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage2 = RSU6(64,32,128)
        #   self.inv_2 = INVOL(128)
        self.pool23 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage3 = RSU5(128,64,256)
        #  self.inv_3 = INVOL(256)
        self.pool34 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage4 = RSU4(256,128,512)
        #   self.inv_4 = INVOL(512)
        self.pool45 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage5 = RSU4F(512,256,512)
        #  self.inv_5 = INVOL(512)
        self.pool56 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage6 = RSU4F(512,256,512)
        #  self.inv_6 = INVOL(512)

        # decoder
        self.stage5d = RSU4F(1024,256,512)
        #  self.inv_5d = INVOL(512)

        self.stage4d = RSU4(1024,128,256)
        #   self.inv_4d = INVOL(256)

        self.stage3d = RSU5(512,64,128)
        #   self.inv_3d = INVOL(128)

        self.stage2d = RSU6(256,32,64)
        #  self.inv_2d = INVOL(64)

        self.stage1d = RSU7(128,16,64)
        #  self.inv_1d = INVOL(64)
    ...
    def forward(self,x):
        ...
        # hx6 = self.stage6(hx)
        # #  hx6 = self.inv_1(hx6)
        hx3up = _upsample_like(hx,hx1)

        #-------------------- decoder --------------------
        # hx5d = self.stage5d(torch.cat((hx6up,hx5),1))
        # #  hx5d = self.inv_5d(hx5d)
        # hx5dup = _upsample_like(hx5d,hx4)
        #
        # hx4d = self.stage4d(torch.cat((hx5dup,hx4),1))
        # # hx4d = self.inv_4d(hx4d)
        # hx4dup = _upsample_like(hx4d,hx3)
        #
        # hx3d = self.stage3d(torch.cat((hx4dup,hx3),1))
        # #  hx3d = self.inv_3d(hx3d)
        # hx3dup = _upsample_like(hx3d,hx2)

        hx2d = self.stage2d(torch.cat((hx3up,hx2),1))
        # hx2d = self.inv_2d(hx2d)
        hx2dup = _upsample_like(hx2d,hx1)

        hx1d = self.stage1d(torch.cat((hx2dup,hx1),1))
        # hx1d = self.inv_1d(hx1d)
